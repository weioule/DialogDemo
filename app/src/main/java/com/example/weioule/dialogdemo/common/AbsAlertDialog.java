 ...
 * 这是支持设置动画的dialog
 */
public class AbsAlertDialog extends Dialog {
     ...
     */
    protected AbsAlertDialog.OnBtnClickL onBtnLeftClickL;
    /**
     * middle btn click listener(中间钮接口)
     */
    protected AbsAlertDialog.OnBtnClickL onBtnMiddleClickL;
    /**
     * right btn click listener(右按钮接口)
     */
    protected AbsAlertDialog.OnBtnClickL onBtnRightClickL;
    /**
     ...
     */
    public void setOnBtnClickL(AbsAlertDialog.OnBtnClickL... onBtnClickLs) {
     ...
     */
    public void showAnim(BaseAnimatorSet showAnim) {
     ...
     */
    public void dismissAnim(BaseAnimatorSet dismissAnim) {
    ...
    public abstract static class BaseAnimatorSet {
        ...
        private BaseAnimatorSet.AnimatorListener listener;
        private long delay;
         ...
         * 动画监听
         */
        public BaseAnimatorSet listener(BaseAnimatorSet.AnimatorListener listener) {
